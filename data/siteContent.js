const siteContent = {
  ...
  achievements: {
    items: [
      { title: "Hult Prize MEC 2023 - First Place", organization: "Hult Prize MEC", description: "Won first place and was invited to China to present the project.", image: "🥇", link: "#" },
      { title: "Millennium Fellowship 2024", organization: "United Nations", description: "Awarded for leadership excellence and fostering social change.", image: "🌍", link: "#" },
      { title: "GirlScript Summer of Code 2024", organization: "GSSoC", description: "Selected as a contributor for open-source development.", image: "💻", link: "#" },
      { title: "Hult Prize MEC 2024 Finalist", organization: "Govt. Model Engineering College", description: "Finalist for WATERWISE, focused on water resource conservation.", image: "🏁", link: "#" },
      { title: "HackerRank C++ Badge", organization: "HackerRank", description: "Earned 4-Star badge in C++ for DSA and problem solving.", image: "⭐", link: "#" },
      { title: "Hackathon Participation", organization: "Excel MEC 2024 / TinkHack 2.0", description: "Participated in HackForTomorrow and Kerala's largest Gen AI hackathon.", image: "🚀", link: "#" },
      { title: "Community & Open Source", organization: "FOSSMEC / Debian", description: "Volunteered for DebUtsav 2024, a Debian Conference organized by FOSS MEC.", image: "🤝", link: "#" },
    ],
    certifications: [
      {
